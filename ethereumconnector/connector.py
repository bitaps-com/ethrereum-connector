...
class Connector:
    def __init__(self,
        ...
        self.db_pool = False
        self.block_table = 'connector_block_ERC20_' + str(token) if token else 'connector_block'
        self.transaction_table = 'connector_transaction_ERC20_' + str(token) if token else 'connector_transaction'
